      ...
      <div className="">
        ...
        <label className="input-label " htmlFor="usernameIn">username</label>
          <input
            ...
            name="username"
            id="usernameIn"
            type="text" placeholder="username" defaultValue={profileInfo?.username}/>
       </div >
        <div className="w-2/3 h-[10vh] flex-col p-2 mb-8">
          ...
          <input
            ...
            name="displayName"
            id="displayNameIn"
            type="text" placeholder="display name" defaultValue={profileInfo?.displayName}/>
        </div>
        </div>
        ...
        <textarea
          ...
          id="bioIn"
          name="bio"
          placeholder="bio" defaultValue={profileInfo?.bio}></textarea>
        </div>
